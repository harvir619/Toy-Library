...
<br></br>
<button onclick="window.location.href = 'collection.php';" style="font-family:Impact, Charcoal, sans-serif; font-size:30px; width:100%; background-color:black; color:white; padding:5;"> <-Go to Collection Page </button>
